...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '开课表' ROW_FORMAT = Dynamic;
...
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES ('1101', '李明', '男', '1993-03-06', '上海', '13613005486', '02', NULL, '$2a$12$bAxsNfNAVLB/fIvSW7cZ3.9zM3UYZXHmjoFmxljIbgnu4t07bDEta');
INSERT INTO `student` VALUES ('1102', '刘晓明', '男', '1992-12-08', '安徽', '18913457890', '01', NULL, '$2a$12$7eFveWMHGdFu42JORIJWguQAA4pDO9PeP5PTo8BRhc5czpBc3T1he');
INSERT INTO `student` VALUES ('1103', '张颖', '女', '1993-01-05', '江苏', '18826490423', '01', NULL, '$2a$12$xuK7EfN2KBJN1UFz97zvHe.IcpZSjrGbvZ7NfrusuKkwhCMRR03W2');
INSERT INTO `student` VALUES ('1104', '刘晶晶', '女', '1994-11-06', '上海', '13331934111', '01', NULL, '$2a$12$b6K3n5HyOoKim6ma5fHYP.TmqzHKz9U5zOyZroWZIbohSe9XrRAcO');
INSERT INTO `student` VALUES ('1105', '刘成刚', '男', '1991-06-07', '上海', '18015872567', '01', NULL, '$2a$12$/f2Qh.x9VOH1xqP9Xn/GN.v4rSWF2kjOoyV6T7u6hc.GnPoYcejoS');
INSERT INTO `student` VALUES ('1106', '李二丽', '女', '1993-05-04', '江苏', '18107620945', '01', NULL, '$2a$12$wWXnsXN1Z8nSczWMdgJWi.ht2Cdy8rp21JQcnW.Jbqkjwg3lm4rVS');
INSERT INTO `student` VALUES ('1107', '张晓峰', '男', '1992-08-16', '浙江', '13912341078', '01', NULL, '$2a$12$t4L2hyfN1QMsFJbKfF/8PeqWC7WvEdO/BUtReAHUZ6yddanz0ON2q');
INSERT INTO `student` VALUES ('1108', '张三', '男', '2001-01-01', '某地', '12345678901', '01', NULL, '$2a$12$rf2hr7b2Z7.QR6Lc7fVBIOUctJZCqsZE8J/FaYTlN99OEpkr0PWn2');
INSERT INTO `student` VALUES ('1109', '李四', '男', '2002-02-02', '某地', '12345678902', '01', NULL, '$2a$12$wx2DS1O4djFthoejV3iVz.0gN6mQ9Bbc2MNZtDeZta6QFL8hIeJ6S');
INSERT INTO `student` VALUES ('1110', '王五', '男', '2000-03-03', '某地', '12345678903', '01', NULL, '$2a$12$c3GdGhClOyPu/VGH49nTpunL1WO0o.KdKNCXCXHyamMAQJhvjv3si');
INSERT INTO `student` VALUES ('1111', '邱逸轩', '男', '2001-01-01', '北京', '12345678909', '01', NULL, '$2a$12$c7oGJraeBARXmHaEB50mguwrC6y/zEQ7o/mqleyFX9rOfM4oAv3ly');
INSERT INTO `student` VALUES ('1112', '马英九', '男', '1998-12-13', '北京', '12345678909', '02', NULL, '$2a$12$mjoEHIL1yUoO35/X95z9uukrCaOiPiJTFs/VBbi2PkqMH80RqApfK');
